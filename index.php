...
<head>
  ...
  <style>
  .all{
    background:rgba(51,51,51,0.8); color:#FFF; min-height:100px; width:300px; position:absolute; display:none; z-index:9999; overflow:auto;
  }
  </style>
</head>
...
<body>
  ...
  <div id="all">
    ...
    <!-- 使用date函式，小寫l為星期幾，demo右下角改'自動設定時間'。取出是二維陣列，[][] -->
